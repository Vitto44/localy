...
const ShopDetails = (props) => {
  const shop =
    props.shopDetails.show === true ? props.shopDetails.shop[0] : undefined;
    ...
    <div className="shopDetailsWrap" style={style}>
      {props.shopDetails.show === true ? (
        <div className="shopDetails">
          ...
          <button className="unfoldDetailsBtn" onClick={toggleDetails}>
            {shopDetails.isFullyUnfolded ? seeLessButton : seeMoreButton}
          </button>
          <h2 className="shopDetailsShopCategory">{shop.category}</h2>
          <div className="shopDetailsCategory">
            <img
              className="shopDetailsIcon"
          ...
          <button className="closeShopBtn" onClick={hideDetails}>
