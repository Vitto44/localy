...
const CreateShopForm = (props) => {
  ...
  return (
    <div className="createShopFormWrap" style={form.styles}>
      <img
        className="createShopLogotype"
        src={require("../assets/purple_logo_full.png")}
        alt="Localy Logotype"
      />
      <img
        className="createShopPinLogotype"
      ...
      <form onSubmit={handleSubmit}>
        ...
        <input
          ...
          type="text"
          value={shop.category}
          placeholder="Enter a category (e.g. Coffee House)"
          required
        />
        <input
          className="createShopFormInput"
        ...
        <input
          ...
          type="email"
          value={shop.email}
          placeholder="Where to e-mail you?"
        />
        <input
          className="createShopFormInput"
          name="website"
        ...
        />
        <textarea
          className="describeShopFormInput"
          name="description"
          onChange={handleInputChange}
        ...
        <input
          ...
          type="text"
          value={shop.latitude}
          placeholder="Enter the exact latitude"
          required
        />
        <input
          className="createShopFormInput"
          ...
          placeholder="Enter the exact longitude"
          required
        />
        ...
        <label className="createShopFormFileLabel" htmlFor="fileUpload">
          Select Main Picture
        </label>
        <input
          className="createShopFormFileInput"
          id="fileUpload"
          name="picture"
        ...
        {previewSource && (
          <div className="imgWrap">
            <img src={previewSource} alt="Your shop"></img>
          </div>
        )}
        <button className="submitBtn submitShopFormBtn" type="submit">
          Place in map!
        </button>
      </form>
